...
export default function MapScreen() {
  ...
  const nav = useDirections(mapRef, loc.userLocation, () =>
    loc.startWatch(true),
  );
                  ...
                  {bay.polygons ? (
                    bay.polygons.map((path, i) => (
                      <PolygonF
                        ...
                        options={{
                          ...
                          fillOpacity:
                            nav.activeRouteBay?.id === bay.id ? 0.26 : 0.13,
                          strokeColor: STATUS_COLORS[bay.status],
                          strokeOpacity: 0.82,
                          strokeWeight:
                            nav.activeRouteBay?.id === bay.id ? 4 : 2,
                          clickable: true,
                    ...
                    <PolylineF
                      ...
                      options={{
                        ...
                        strokeOpacity: 0.96,
                        strokeWeight:
                          nav.activeRouteBay?.id === bay.id ? 11 : 8,
                        clickable: true,
